...
当接口本身的形态存疑时——模块应该多深、接缝应该在哪里、接口应该暴露什么——使用 `/codebase-design` 技能获取相关词汇。它是 module、interface、depth、seam、adapter、leverage 和 locality 这些术语的共享来源，是一份按需查阅的参考，而不是一个需要运行的会话。
