...
description: 为 agent 撰写文档。适用于创建或编辑 skills，或修改 AGENTS.md / CLAUDE.md 的场景。
---
...
当你撰写的文档是一份 skill 时，阅读 [`SKILL-MECHANICS.md`](SKILL-MECHANICS.md) 了解 frontmatter、调用方式选择和路由技能。
...
- **按调用方式拆分**——skill 特有：见 [`SKILL-MECHANICS.md`](SKILL-MECHANICS.md)。
